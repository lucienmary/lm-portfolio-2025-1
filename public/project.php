...
<section class="min-h-screen flex relative">
  <div class="container m-auto w-full">
    <div class="px-6 xl:px-24 relative grid lg:grid-cols-2 gap-18 xl:gap-24">
      <div class="col-span-1 z-1 flex flex-col justify-center">
        <span class="font-sans-serif text-md xl:text-lg font-extralight text-gray-400 mb-2 xl:mb-4"><?= $meta['class'] ?></span>
        <h1 class="font-sans-serif text-5xl xl:text-6xl font-bold mb-6 xl:mb-10"><?= $meta['title'] ?></h1>
        <p><?= $meta['desc'] ?></p>
      </div>
      <div class="col-span-1">
        <div class="p-[1px] bg-[linear-gradient(to_bottom_left,rgba(255,255,255,1)_1%,rgba(46,151,255,1)_18%,rgba(46,151,255,1)_32%,rgba(255,255,255,1)_50%,rgba(250,0,217,0.88)_68%,rgba(250,0,217,0.88)_82%,rgba(255,255,255,0.75)_100%)] rounded-[calc(theme('borderRadius.3xl')_+_1px)] md:rounded-[calc(theme('borderRadius.4xl')_+_1px)]">
          <div class="rounded-3xl md:rounded-4xl w-full h-auto object-cover p-2 md:p-3 bg-main">
            <img src="<?= $meta['image'] ?>" alt="<?= $meta['title'] ?>" class="shadow-md shadow-gray-600 rounded-2xl md:rounded-3xl">
          </div>
        </div>
      </div>
    </div>
...
<section id="project-desc" class="relative">
  <div class="container m-auto px-6 lg:px-24 py-24 xl:py-48 font-light grid lg:grid-cols-3 gap-12 xl:gap-24">
    <div class="col-span-2 text-lg">
      ...
      <?php if (isset($meta['isOnline']) && $meta['isOnline']): ?>
        <a href="<?= $meta['url'] ?>" target="_blank"
          class="flex lg:inline-flex justify-center font-sans-serif border px-4 py-1 mt-12 rounded-lg border-green-500 hover:border-green-400 duration-100 btn-magic">
          Visiter le projet
    ...
    <div class="xl:col-span-1 text-lg">
