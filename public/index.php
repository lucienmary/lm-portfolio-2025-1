...
<section class="min-h-screen flex relative">
    <div class="container m-auto">
        <div class="px-6 xl:px-24 relative">
            <div class="relative z-1">
                <h1 class="font-sans-serif">
                    <span class="text-2xl 2xl:text-3xl font-extralight text-gray-400">Hello, je suis</span>
                    <span class="font-bold block text-8xl 2xl:text-9xl">Lucien Mary</span>
                    <span class="text-3xl/20 2xl:text-5xl/24 me-3 font-normal">Développeur Front end</span>
                    <span class="text-xs 2xl:text-sm border border-gray-400 text-gray-300 pe-3 py-[2px] md:mt-8 xl:mt-9 rounded-md xl:rounded-lg align-top hidden md:inline-block"><span class="wing"></span> Disponible</span>
                </h1>
                <div class="font-sans-serif font-light text-xl xl:text-2xl text-left sm:text-center pt-18 flex flex-col md:flex-row gap-6">
            ...
            <div class="absolute top-1/2 left-1/2 -translate-y-1/2 lg:ps-5 xl:ps-0 xl:max-2xl:-ms-12 z-0 hidden lg:block">
                <!-- <img src="content/img/bg-lm-hero.svg" alt="Photo de Lucien Mary"> -->
                 <img width="650" class="opacity-95" src="content/img/lucien-mary-developpeur-frontend-designer.png" alt="Lucien Mary, développeur front end">
...
<section id="about" class="relative">
    <div class="container m-auto px-12 xl:px-24 py-24 xl:py-48 font-light grid lg:grid-cols-3 gap-12 lg:gap-24">
...
<section class="h-min-[90vh] bg-white text-black px-6 xl:px-0 py-12 xl:py-24 relative">
    <div class="container m-auto">
        ...
        <div class="follow-cursor-wrapper relative">
            <div class="swiper h-full relative">
                <div class="swiper-wrapper h-full z-1">
                    <?php foreach ($projects as $p): ?>
                        <div class="swiper-slide flex items-center justify-center h-full">
                            <div class="grid md:grid-cols-3 gap-6 md:gap-24 w-full">
                                <?php if (!empty($p['image'])): ?>
                                    <div class="p-[1px] md:col-span-2 bg-[linear-gradient(to_bottom_left,rgba(17,17,18,1)_1%,rgba(46,151,255,1)_18%,rgba(46,151,255,1)_32%,rgba(17,17,18,1)_50%,rgba(250,0,217,0.88)_68%,rgba(250,0,217,0.88)_82%,rgba(17,17,18,0.75)_100%)] rounded-4xl-1 rounded-[calc(theme('borderRadius.4xl')_+_1px)]">
                                        <div class="rounded-4xl w-full h-auto object-cover p-3 xl:p-4 bg-white">
                ...
                <div class="mt-12 xs:mt-0 flex lg:inline gap-6 justify-center">
                    <div class="swiper-button-prev-nostyle lg:absolute top-0 left-0 bottom-0 max-lg:h-[2rem] w-[2rem] lg:w-1/2 max-lg:bg-black max-lg:rounded-full xs:rounded-none z-10 cursor-pointer flex items-center justify-start">
                        <svg class="fill-white lg:hidden" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><title>chevron-left</title><path d="M15.41,16.58L10.83,12L15.41,7.41L14,6L8,12L14,18L15.41,16.58Z" /></svg>
                    </div>
                    <div class="swiper-button-next-nostyle lg:absolute top-0 right-0 bottom-0 max-lg:h-[2rem] w-[2rem] lg:w-1/2 max-lg:bg-black max-lg:rounded-full xs:rounded-none z-10 cursor-pointer flex items-center justify-end">
                        <svg class="fill-white lg:hidden" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><title>chevron-right</title><path d="M8.59,16.58L13.17,12L8.59,7.41L10,6L16,12L10,18L8.59,16.58Z" /></svg>
                    </div>
                </div>
            </div>
            <div
...
<section id="contact" class="bg-white text-black text-center pt-12 pb-24 md:pb-36 xl:pb-48">
    <div class="container m-auto">
        <h2 class="font-sans-serif font-medium text-4xl/20 xl:text-6xl/20">Me contacter&nbsp;?</h2>
        <div class="font-sans-serif text-xl xl:text-2xl flex gap-6 justify-center mt-12 xl:mt-18">
            <a href="https://www.linkedin.com/in/lucien-mary-437598177/" target="_blank" class="border px-4 py-1 rounded-lg border-blue-500 hover:border-blue-400 duration-100 btn-magic">
